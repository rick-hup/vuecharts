...
│   ├── layouts/
│   │   └── default.vue     # Persistent layout: sticky header (BarChart3 icon + "vccs playground" logo, nav links /bar-charts + /area + /line-charts + /pie-charts + /radar-charts with active bg-accent state, dark mode toggle Moon/Sun via useColorMode()), main <slot />
│   ├── app.vue             # Root: <NuxtLayout> wrapping <NuxtRouteAnnouncer /> + <NuxtPage />
│   └── pages/              # index.vue (card-grid nav: 5 routes — bar-charts/area/line-charts/pie-charts/radar-charts, counts: 10/10/10/10/11, grid grid-cols-1/sm:grid-cols-2/lg:grid-cols-4, shadcn Cards + lucide icons BarChart3/AreaChartIcon/LineChartIcon/PieChartIcon/RadarIcon + ArrowRight "View demos" link), bar-charts.vue (10 variants: BarChartInteractive spans full md:col-span-2 lg:col-span-3, 9 others in responsive grid), area.vue (10 area chart SFC components: AreaChartInteractive spans full md:col-span-2 lg:col-span-3, 9 others in md:grid-cols-2 lg:grid-cols-3), line-charts.vue (10 variants: LineChartInteractive spans full md:col-span-2 lg:col-span-3, 9 others in md:grid-cols-2 lg:grid-cols-3), radar-charts.vue (11 variants in grid-cols-1/md:grid-cols-2/lg:grid-cols-3, no full-width interactive item)
