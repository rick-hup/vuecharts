...
::chart-demo{name="Step Area Chart" description="An area chart with step interpolation." src="area-charts/step-area-chart"}
::
...
::chart-demo{name="Area Chart with Legend" description="Two area series with a legend." src="area-charts/legend-area-chart"}
::
