...
| `onClick` | `(node, index, event) => void` | — | Click event handler |
| `onMouseEnter` | `(node, index, event) => void` | — | Mouse enter handler |
| `onMouseLeave` | `(node, index, event) => void` | — | Mouse leave handler |
